...
public class MiPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage message) {
        if (MiPushManager.sMessageProvider == null) {
            return;
        }
        ...
        MiPushManager.sMessageProvider.onReceivePassThroughMessage(context, mixPushMessage);
    }
    ...
    public void onNotificationMessageClicked(Context context, MiPushMessage message) {
        ...
        mixPushMessage.setAlias(message.getAlias());
        mixPushMessage.setPassThrough(message.getPassThrough());
        MiPushManager.sMessageProvider.onNotificationMessageClicked(context, mixPushMessage);
    }
